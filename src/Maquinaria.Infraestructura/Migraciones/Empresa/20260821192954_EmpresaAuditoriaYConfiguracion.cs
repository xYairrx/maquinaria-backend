...
{
    /// <inheritdoc />
    public partial class EmpresaAuditoriaYConfiguracion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ancho_px = table.Column<int>(type: "integer", nullable: true),
                    alto_px = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("archivo_tamano", "tamano_bytes > 0");
                    table.ForeignKey(
                        name: "fk_archivo_subido_por",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("parametro_tipo", "tipo BETWEEN 1 AND 6");
                });

            migrationBuilder.CreateIndex(
                name: "archivo_ruta_unica",
                table: "archivo",
                column: "ruta",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_archivo_subido_por_id",
                table: "archivo",
                column: "subido_por_id");

            migrationBuilder.CreateIndex(
                name: "ix_archivo_vigentes",
                table: "archivo",
                column: "creado_en",
